...
function payWithPaystack(e) {
    ...
    let handler = PaystackPop.setup({
        ...
        //ref: 'EDSU' + Math.floor((Math.random() * 1000000000) + 1), // generates a pseudo-unique reference. Please replace with a reference you generated. Or remove the line entirely so our API will generate one for you
        ...
        callback: function (response) {
            ...
            if (status == "success") {
                ...
                $.ajax({
                    ...
                    data: { data: data },
                    success: function () {
                        window.location = "https://localhost:7117/Wallet/receipt"
